...
export default function AddBlog() {
     ...
     * Title change
     *
     * Automatically generates slug until
     * the user manually changes the slug.
     * ---------------------------------------------
     */
     ...
     * Remove image
     *
     * This removes the image from the form.
     * Cloudinary deletion will be handled later
     * when we add proper media cleanup.
     * ---------------------------------------------
     */

"use client";
const imgInfo1 = '/assets/images/softbild-info11.png';
const imgInfo2 = '/assets/images/softbild-info2.png';

const impoweringBusinessIcon = '/assets/icons/empowering-business-icon.svg';
const innovationIcon = '/assets/icons/innovation-icon.svg';

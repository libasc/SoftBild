...
const ReviewerImg = '/assets/images/reviewer-img1.png';
const nicoleImage = '/assets/images/reviewer/softbild-nicole.jpg';
const vinceImage = '/assets/images/reviewer/softbild-vince.jpg';

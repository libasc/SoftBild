...
const heroImage = "/assets/images/SoftBild-Home-Hero2.png";
                ...
                <div className="container">
                    <div className="row home-hero">
                        <div className="home-h-content">
                            ...
                            <p className="dark-title3">
                                Empowering your vision with top-notch technology
                                solutions tailored to drive growth and optimize
                                business operations.
                            </p>

                            <Link
                                href="/hire-developer"
                                className="sf-btn1 pe-2"
                            >
                                Get Started
                        ...
                        <div className="home-h-video">
                            <div className="home-h-video-wrapper d-flex justify-content-center align-items-center gap-2">
                                <img
                                    src={heroImage}
                                    alt="SoftBild technology solutions"
                                    className="img-fluid"
                                />
                            </div>
                        </div>

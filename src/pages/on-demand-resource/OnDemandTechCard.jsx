...
const ServiceUiuxIcon = '/assets/icons/service-uiux.svg';
const ServiceWebAppDevelop = '/assets/icons/service-webapplication.svg';
const ServiceMobileAppDevelop = '/assets/icons/service-mobileapplication.svg';
const ServiceEcommerceDevelop = '/assets/icons/service-ecommercedev.svg';
const ServiceErpDev = '/assets/icons/service-erpdev.svg';
const ServiceCrmDev = '/assets/icons/service-crmdev.svg';

const uiIcon = '/assets/icons/technology-icon/softbild-ui.svg';
const htmlIcon = '/assets/icons/technology-icon/softbild-html.svg';
const reactIcon = '/assets/icons/technology-icon/softbild-react.svg';
const angularIcon = '/assets/icons/technology-icon/softbild-angular.svg';
const dotnetIcon = '/assets/icons/technology-icon/softbild-dotnet.svg';
const pythonIcon = '/assets/icons/technology-icon/softbild-python.svg';
const javaIcon = '/assets/icons/technology-icon/softbild-java.svg';
const cPlusPlusIcon = '/assets/icons/technology-icon/softbild-cplusplus.svg';
const javascriptIcon = '/assets/icons/technology-icon/softbild-javascript.svg';
const flutterIcon = '/assets/icons/technology-icon/softbild-flutter.svg';
const phpIcon = '/assets/icons/technology-icon/softbild-php.svg';
const wordpressIcon = '/assets/icons/technology-icon/softbild-wordpress.svg';
const fullstackIcon = '/assets/icons/technology-icon/softbild-fullstack.svg';
const sqlIcon = '/assets/icons/technology-icon/softbild-sql.svg';

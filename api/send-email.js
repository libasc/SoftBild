...
if (formType === "contact") {
    const { data, error } = await supabaseAdmin
        ...
        .insert({
            ...
            consultation_datetime: dateTime || null,
    ...
    if (error) {
        console.error("Contact inquiry database error:", error);
    ...
    const { data, error } = await supabaseAdmin
        ...
        .insert({
            ...
            developers_required: developers || null,
            consultation_required: Boolean(consultation),
    ...
    if (error) {
        console.error("Hire developer inquiry database error:", error);
